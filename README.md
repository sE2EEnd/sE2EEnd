...
sE2EEnd uses **AES-256-GCM** encryption, performed entirely client-side via the [Web Crypto API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Crypto_API). The server **never** has access to encryption keys or unencrypted data.

See the full diagram: [Encryption Flow](docs/encryption-flow.mermaid)
